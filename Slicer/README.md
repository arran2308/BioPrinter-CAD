...
Parts have been orientated for both optimised part strength and printability - it should not be necessary to reorientate any part included in the project file.
